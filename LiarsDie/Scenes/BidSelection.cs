...
public class BidSelection : Spatial
{
    [Signal]
    public delegate void FaceIncreaseInputHandler();
    [Signal]
    public delegate void FaceDecreaseInputHandler();
    [Signal]
    public delegate void FreqIncreaseInputHandler();
    [Signal]
    public delegate void FreqDecreaseInputHandler();
    [Signal]
    public delegate void SubmitInputHandler();
    [Signal]
    public delegate void BluffInputHandler();
